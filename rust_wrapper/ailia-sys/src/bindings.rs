...
pub const AILIA_MEMORY_REDUCE_CONSTANT_WITH_FILE_MAPPED: u32 = 16;
...
extern "C" {
    ...
    pub fn ailiaCopyBlobData(
        dst_net: *mut AILIANetwork,
        dst_blob_idx: ::std::os::raw::c_uint,
        src_net: *mut AILIANetwork,
        src_blob_idx: ::std::os::raw::c_uint,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
...
extern "C" {
    ...
    pub fn ailiaFinalize() -> ::std::os::raw::c_int;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
